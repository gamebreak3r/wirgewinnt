...
public class GameBoard {
    ...
    private void markStones(int mode, int column, int row) {
        ...
        switch (mode) {
            ...
            case 2: //horizontal
                ...
                for (; i < 4; i++) {
                    if (column + j < 7 && gameBoard[column + j][row].status == status)
                        gameBoard[column + j][row].status = 3;
                    j++;
                }
                break;
            ...
            case 3: //digonal1
                ...
                for (; i < 4; i++) {
                    if (column + j < 7 && row + j < 7 && gameBoard[column + j][row + j].status == status)
                        gameBoard[column + j][row + j].status = 3;
                    j++;
                }
                break;
            case 4: //digonal2
                ...
                for (; i < 4; i++) {
                    if (column + j < 7 && row - j >= 0 && gameBoard[column + j][row - j].status == status)
                        gameBoard[column + j][row - j].status = 3;
                    j++;
                }
                break;
